 ...
 */
(function(c){function b(a){this.c=a;this.a={device:!1,type:!1,browser:!1,os:!1};this.f={iPod:"\\biPod",iPhone:"\\biPhone.*Mobile",BlackBerry:"BlackBerry|\\bBB10\\b|rim[0-9]+",WindowsPhone:"(?=.*Windows.*)(?=.*Phone.*)",AndroidMobile:"(?=.*Android.*)(?=.*Mobile.*)",GenericMobile:"Mobile"};this.i={iPad:"iPad|iPad.*Mobile",BlackBerryTablet:"PlayBook|RIM Tablet",WindowsTablet:"Windows NT [0-9.]+; ARM;|(?=.*Windows.*)(?=.*Touch.*)",AndroidTablet:"\\bAndroid\\b"};this.e={Chrome:"\\bCrMo\\b|CriOS|Android.*Chrome/[.0-9]*(Mobile)?",
